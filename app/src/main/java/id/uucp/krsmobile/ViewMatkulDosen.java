...
import id.uucp.krsmobile.AdapterRecycleView;
import id.uucp.krsmobile.Matkul;

public class ViewMatkulDosen extends AppCompatActivity implements AdapterRecycleView.FirebaseDataListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_matkul_dosen);
        ...
        database.child("matkul").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter = new AdapterRecycleView(daftarMatkul, ViewMatkulDosen.this);
    ...
    public static Intent getActIntent(Activity activity){
        return new Intent(activity, ViewMatkulDosen.class);
    }
        ...
        if(database!=null){
            database.child("matkul").child(matkul.getKey()).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                ...
                public void onSuccess(Void aVoid) {
                    Toast.makeText(ViewMatkulDosen.this,"success delete", Toast.LENGTH_LONG).show();
                }
            });
        }
    }
